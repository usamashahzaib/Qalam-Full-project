              ...
              return <article key={pack.key} className={featured ? "row-span-3 rounded-3xl bg-zinc-900 p-7 text-white lg:p-9" : "border-t border-zinc-300 py-5 lg:px-2"}>
                <div className="flex flex-wrap items-start justify-between gap-4">
                  <div className="max-w-xl">
                    {featured ? <span className="rounded-full bg-gold px-3 py-1 t-eyebrow text-teal-900">Recommended</span> : null}
              ...
              return <article key={item.key} className="grid gap-5 py-6 md:grid-cols-[2rem_minmax(0,1fr)_auto] md:items-center">
                ...
                <div>
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    <span className="rounded-full bg-zinc-100 px-2.5 py-1 t-eyebrow text-zinc-600">{item.creditCost} plan {item.creditCost === 1 ? "credit" : "credits"}</span>
                    {specificCredits > 0 ? <span className="rounded-full bg-teal/10 px-2.5 py-1 t-eyebrow text-teal">{specificCredits} purchased</span> : null}
                  </div>
