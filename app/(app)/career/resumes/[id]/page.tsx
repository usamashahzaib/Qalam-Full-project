    ...
    <main className="min-h-full bg-zinc-100 px-4 py-5 lg:px-6">
      ...
      <div className="mx-auto max-w-[1500px]">
        <header className="mb-4 flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-zinc-200 bg-white px-5 py-4 print:hidden">
          <div><p className="t-eyebrow text-teal">Resume editor</p><input aria-label="Resume title" className="mt-1 min-w-72 border-0 p-0 text-xl font-bold text-zinc-900 outline-none" disabled={saving || downloading !== null} value={document.title} onChange={(event) => setDocument({ ...document, title: event.target.value })} /></div>
