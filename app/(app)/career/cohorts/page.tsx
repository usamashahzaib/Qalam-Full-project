          ...
          <div className="grid gap-3 md:grid-cols-3">
            {cohorts.map((cohort) => (
              <article key={cohort.id} className="rounded-xl border border-zinc-200 bg-white p-5">
                <div className="flex justify-between"><span className="rounded-full bg-teal/10 px-2 py-1 text-[10px] font-bold uppercase text-teal">{cohort.role}</span><span className="font-mono text-xs font-bold text-gold-700">{cohort.code}</span></div>
