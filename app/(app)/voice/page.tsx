...
export default function VoicePage() {
  ...
  return (
      <div className="mx-auto max-w-[960px] px-4 py-8 lg:px-6">
        ...
        {/* Header */}
        <div className="mb-8">
          <p className="t-eyebrow text-zinc-400">Voice &amp; Identity</p>
          ...
          <div className="grid gap-6 lg:grid-cols-[1fr_360px]">
            ...
            <div className="space-y-5">
              ...
              <section className="overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-sm">
                ...
                <div className="grid gap-4 p-5 sm:grid-cols-2">
                  <div>
                    <label className="mb-1.5 block t-eyebrow text-zinc-400">Name</label>
                  ...
                  <div>
                    <label className="mb-1.5 block t-eyebrow text-zinc-400">Job Title</label>
                  ...
                  <div>
                    <label className="mb-1.5 block t-eyebrow text-zinc-400">Industry</label>
                  ...
                  <div>
                    <label className="mb-1.5 block t-eyebrow text-zinc-400">LinkedIn URL</label>
                  ...
                  <div className="sm:col-span-2">
                    <label className="mb-1.5 block t-eyebrow text-zinc-400">Brand Tone</label>
              ...
              <LockedFeature requiredPlan="Pro" feature="Voice Training">
                <div className="space-y-5">
                  ...
                  <section className="overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-sm">
                  <div className="border-b border-zinc-100 bg-zinc-50/60 px-5 py-3.5">
                    <h2 className="text-sm font-bold text-zinc-900">Voice training <span className="ml-1 rounded-full bg-amber-100 px-2 py-0.5 t-eyebrow text-amber-700">Pro</span></h2>
            ...
            <aside className="space-y-4">
              <div className="overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-sm">
                <div className="border-b border-zinc-100 bg-zinc-50/60 px-4 py-3.5">
                  <div className="flex items-center justify-between">
                    <h2 className="t-eyebrow text-zinc-500">Voice Characteristics</h2>
                    {isAnalyzing && <span className="animate-pulse t-eyebrow font-semibold text-teal">Analyzing...</span>}
                  </div>
                </div>
                ...
                {characteristics && (
                  ...
                  <div className="divide-y divide-zinc-100">
                    ...
                    <div className="px-4 py-3">
                      <p className="t-eyebrow text-zinc-400">Transition Words</p>
                      <div className="mt-1.5 flex flex-wrap gap-1">
                    ...
                    <div className="px-4 py-3">
                      <p className="t-eyebrow text-zinc-400">CTA Style</p>
                  ...
                  <div className="p-4 space-y-3">
                    {["Tone", "Sentence Length", "Vocabulary", "Common Phrases", "Transitions", "CTA Style"].map((label) => (
                      <div key={label}>
                        <p className="t-eyebrow text-zinc-300">{label}</p>
              ...
              <div className="rounded-2xl border border-zinc-200 bg-white p-4">
                <p className="t-eyebrow text-zinc-400">Writer integration</p>
