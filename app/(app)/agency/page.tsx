...
export default function AgencyDashboard() {
  ...
  return (
    <PlanGate requiredPlan="Agency" feature="Agency Hub" description="Apply for Agency to access five client workspaces, team seats, approvals, and analytics.">
              ...
              {isLoading ? (
                ...
                clients.map((client) => {
                  ...
                  <div key={client.id} className={`p-6 transition-colors hover:bg-zinc-50 ${active ? "bg-teal/[0.04]" : ""} ${archived ? "opacity-60" : ""}`}>
                    <div className="flex flex-wrap items-center justify-between gap-4">
                      ...
                      <div>
                        <div className="flex flex-wrap items-center gap-2">
                          ...
                          {active ? <span className="rounded-full bg-teal px-2 py-0.5 t-eyebrow text-white">Active</span> : null}
                        </div>
                        ...
                        <p className="mt-0.5 t-eyebrow font-medium text-zinc-400">Expires {fmtDate(client.planExpiresAt)}</p>
                      </div>
                      </div>
                    ...
                    {client.draftsLimit ? (
                      <div className="mt-3">
                        <div className="mb-1 flex items-center justify-between t-eyebrow text-zinc-400">
