      ...
      <div className="relative mb-8 overflow-hidden rounded-2xl border border-zinc-100 bg-white px-6 py-5 shadow-sm">
        ...
        <div className="relative flex items-end justify-between gap-4">
          ...
          <div className="flex shrink-0 items-center gap-3">
            ...
            <Link href={withClientParam("/writer", activeClientId)} className="rounded-xl bg-teal px-4 py-2 text-sm font-bold text-white shadow-sm transition-colors hover:bg-teal-600">+ Generate from Writer</Link>
          </div>
        </div>
      </div>
