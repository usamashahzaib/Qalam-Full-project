      ...
      <div className="mx-auto max-w-[720px]">
        ...
        <div className="space-y-8 text-zinc-700">
          ...
          <section>
            ...
            <p>You may request deletion of your account and all associated data by emailing <a href={`mailto:${SUPPORT_EMAIL}`} className="text-teal underline">{SUPPORT_EMAIL}</a>. We will process deletion requests within 7 business days.</p>
          </section>
          ...
          <section>
            ...
            <ul className="mt-3 list-disc pl-5 space-y-2">
              ...
              <li><strong>Groq / Google Gemini / OpenRouter</strong> - AI content generation. When you generate a post, your topic, role, and writing preferences are routed to one of these providers to produce draft text. Prompts are not used to train their public models per their enterprise terms.</li>
          ...
          <section>
            ...
            <p>For privacy questions, contact us at <a href={`mailto:${SUPPORT_EMAIL}`} className="text-teal underline">{SUPPORT_EMAIL}</a>.</p>
          </section>
        </div>
      </div>
    </div>
