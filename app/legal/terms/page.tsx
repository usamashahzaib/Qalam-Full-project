      ...
      <div className="mx-auto max-w-[720px]">
        ...
        <div className="space-y-8 text-zinc-700">
          ...
          <section>
            ...
            <p>Paid plans are sold as recurring subscriptions and are processed by our payment provider, Lemon Squeezy, which acts as merchant of record. Card payments activate the plan automatically. Where payment is instead made by JazzCash, Easypaisa, or bank transfer, the plan is activated manually after we verify receipt. Prices are listed in US Dollars (USD). Purchasing-power-adjusted pricing may be available in select regions. Subscriptions renew on the cycle agreed at the time of purchase until cancelled.</p>
