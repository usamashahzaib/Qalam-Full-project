      ...
      <div className="mx-auto max-w-[720px]">
        ...
        <div className="space-y-8 text-zinc-700">
          ...
          <section>
            ...
            <p>Paid plans are activated upon receipt of full payment via JazzCash, Easypaisa, or bank transfer. All amounts are in Pakistani Rupees (PKR) unless otherwise stated. Subscriptions renew on the cycle agreed at the time of purchase.</p>
