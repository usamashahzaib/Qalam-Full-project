...
const TOOLS = alphabetical([
  ...
  {
    icon: MicroscopeIcon,
    title: "Post Quality Checker",
    desc: "Paste a post and get a structured review of clarity, specificity, usefulness, and the hook.",
    badge: null,
    badgeColor: "",
  ...
  {
    icon: AnalyticsIcon,
    title: "Post Readiness Review",
    desc: "Get a pre-publish quality score based on structure, specificity, audience fit, and clarity.",
    badge: null,
    badgeColor: "",
