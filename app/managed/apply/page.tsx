        ...
        <div className="mx-auto max-w-[980px]">
          <FadeUp>
            ...
            <p className="max-w-2xl text-lg leading-relaxed text-zinc-600">
              {isAgency
                ? "Agency is PKR 3,999/month and PKR 7,998 billed quarterly. Apply below for workspace activation."
                : "For founders and executives who want a consistent LinkedIn presence without doing the writing. Apply below and we'll confirm fit, pricing, and a start date within one business day."}
            </p>
          </FadeUp>
        </div>
      </section>
            ...
            <div className="space-y-4">
              ...
              {isAgency && (
                <div className="rounded-2xl border border-teal/30 bg-teal/5 p-6 shadow-sm">
                  <p className="text-xs font-semibold uppercase tracking-widest text-gold">Agency</p>
                  <p className="mt-1 text-2xl font-bold text-zinc-900">PKR 3,999<span className="text-sm font-medium text-zinc-500">/month</span></p>
                  <p className="mt-1 text-xs font-semibold text-emerald-700">PKR 7,998 quarterly - 1 month free</p>
