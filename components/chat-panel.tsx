    ...
    return (
      <div className="flex justify-end">
        <div className="group relative mb-7 max-w-[78%]">
          ...
          <span className="pointer-events-none absolute -bottom-5 right-0 t-eyebrow text-zinc-400 opacity-0 transition-opacity group-hover:opacity-100">
            {time}
          </span>
        </div>
      </div>
        ...
        <div className="rounded-2xl rounded-tl-sm border border-zinc-200 bg-white px-4 py-3 text-sm leading-relaxed text-zinc-900 shadow-sm">
          ...
          <div className="mt-2.5 flex items-center gap-3 border-t border-zinc-100 pt-2">
            <button
              ...
              className="t-eyebrowr text-zinc-400 transition-colors hover:text-zinc-700"
            >
              Copy
            </button>
            <button
              onClick={() => onUseAsPost(msg.content)}
              className="t-eyebrowr text-teal transition-colors hover:text-teal-700"
            >
              Use as post
            </button>
          </div>
        </div>
        <span className="pointer-events-none absolute -bottom-5 left-0 t-eyebrow text-zinc-400 opacity-0 transition-opacity group-hover:opacity-100">
          {time}
        </span>
      </div>
    </div>
        ...
        <aside className="flex w-52 shrink-0 flex-col border-r border-zinc-100 bg-zinc-50">
          <div className="border-b border-zinc-100 px-3 py-3">
            <div className="mb-2 flex items-center justify-between">
              <p className="t-eyebrowst text-zinc-400">Chats</p>
              <button
            ...
            {conversations.length === 0 ? (
              ...
              conversations.map((conv) => (
                ...
                >
                  ...
                  <p className="mt-0.5 t-eyebrow text-zinc-400">
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        <div className="flex items-center gap-2 border-b border-zinc-100 px-4 py-3">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="t-eyebrow text-zinc-400">Enter to send · Shift+Enter for new line</p>
          </div>
          {copiedFlash && (
            <span className="t-eyebrow font-semibold text-teal">Copied!</span>
          )}
        </div>
