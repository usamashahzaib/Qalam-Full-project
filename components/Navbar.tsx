      ...
      <AnimatePresence>
        {open && (
          ...
          >
            ...
            <div className="p-2">
              <Link href="/app/settings" onClick={() => setOpen(false)} className="flex items-center gap-2.5 rounded-xl px-3 py-2.5 text-sm font-medium text-zinc-700 transition-colors hover:bg-teal/5 hover:text-teal">
              ...
              <Link href="/app" onClick={() => setOpen(false)} className="flex items-center gap-2.5 rounded-xl px-3 py-2.5 text-sm font-medium text-zinc-700 transition-colors hover:bg-teal/5 hover:text-teal">
                <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                ...
                <div className="mt-3 flex flex-col gap-1 border-t border-zinc-200 pt-3">
                  {status === "loading" ? (
                    ...
                    <>
                      ...
                      <Link href="/app/settings" onClick={() => setMobileOpen(false)} className="rounded-lg px-3 py-2.5 text-sm font-medium text-zinc-600 hover:bg-teal/10 hover:text-teal">Settings</Link>
                      <Link href="/app" onClick={() => setMobileOpen(false)} className="rounded-lg px-3 py-2.5 text-sm font-medium text-zinc-600 hover:bg-teal/10 hover:text-teal">Dashboard</Link>
