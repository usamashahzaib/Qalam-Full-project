        ...
        <div className="mx-auto max-w-[760px] space-y-6">
          <div className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm">
            ...
            <div className="flex gap-3">
              <input aria-label="Your LinkedIn headline" type="text" value={headline} onChange={(e) => setHeadline(e.target.value)} onKeyDown={(e) => e.key === "Enter" && void analyze()} placeholder="e.g. Founder & CEO | Helping B2B SaaS teams grow" className="flex-1 rounded-xl border border-zinc-200 px-4 py-3 text-sm outline-none focus:border-teal/50 focus:ring-2 focus:ring-teal/30" />
