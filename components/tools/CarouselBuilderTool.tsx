              ...
              <div className="space-y-4 rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm">
                ...
                <motion.button
                  ...
                  className={`mt-2 w-full rounded-xl py-3 text-sm font-bold transition-all ${
                    text.trim() && !building ? "bg-teal text-white shadow-sm hover:bg-teal-600" : "cursor-not-allowed bg-zinc-200 text-zinc-400"
                  }`}
                >
                  ...
                  <div className="flex-1 space-y-4">
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className="rounded-xl border border-zinc-200 px-4 py-2 text-sm font-semibold text-zinc-700 transition-colors hover:bg-zinc-50 disabled:opacity-40"
                      >
                        Previous
                      </button>
                      <button
