    ...
    >
      ...
      >
        <div className="flex items-center gap-3 border-b border-zinc-100 px-4 py-3">
          ...
          <input aria-label="Search posts or jump to a page"
            ref={inputRef}
            value={query}
            onChange={(e) => {
          ...
          />
          <kbd className="hidden shrink-0 rounded border border-zinc-200 bg-zinc-50 px-1.5 py-0.5 t-eyebrow font-semibold text-zinc-400 sm:inline">esc</kbd>
        </div>
        ...
        <div className="flex items-center gap-4 border-t border-zinc-100 px-4 py-2.5 t-eyebrow text-zinc-400">
